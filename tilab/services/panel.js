      ...
      const Libraries = ({ lib }) => {
        ...
        const renderExports = (exports) => {
          ...
          return Object.keys(exports).map((key) => {
            ...
            return html`
              <div class="tilab-export-item">
                <span class="tilab-export-key">${key}:</span>
                <span class="tilab-export-value">${displayValue}</span>
              </div>
            `;
          });
        };
        ...
        return html`
          <style>
            ...
            .tilab-export-item {
              display: flex;
              justify-content: space-between;
              padding: calc(var(--tlp-font-size) * 0.125) 0;
              border-bottom: 1px solid rgba(255, 255, 255, 0.05);
            }
            .tilab-export-item:last-child {
              border-bottom: none;
            }
            .tilab-export-key {
              color: #e5e7eb;
            ...
            .tilab-export-value {
              color: #9ca3af;
              margin-left: calc(var(--tlp-font-size) * 0.5);
            }
          </style>
              ...
              ? lib.storage.map((libItem) => {
                  ...
                  return html`
                    <div class="tilab-lib-item">
                      ...
                      >
                        <div
                          style="display: flex; align-items: center; gap: calc(var(--tlp-font-size) * 0.25);"
                        >
                          <span
                            class="tilab-lib-expand ${isExpanded
                              ? "expanded"
                              : ""}"
                            >▶</span
                          >
