 ...
 * <script src = 'https://cdn.abros.dev/tilda/auplida.js'></script>
 */
...
function AudioPlayer(settings) {
  ...
  this.setupProductEvents = function () {
    if (
  ...
  this.progressListen = function (e) {
    ...
    this.audio.addEventListener("timeupdate", this.progressControl.bind(this));
  };

  this.progressControl = function () {
    let per =
  ...
  this.getProducts = function (idArr) {
  ...
  this.playPauseBtnOnProduct = function (e, product) {
  ...
  this.trackLink = function (product) {
