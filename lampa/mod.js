  ...
  function abrosStart(plugins, vipUser, news) {
    ...
    const vipStatus = vipUser
      ? `
            <div class="ad-server" style="margin: 0em 0em; border-radius: 1em;">
                <div class="ad-server__text" style="font-size: 0.9em;">Поздравляем! Ваш статус Vip активирован.<br><b style="color: #ffd402;">💎 VIP ещё ${formatDays(
                  vipUser
                )}</b></div>
                <img src="${domain}/store/img/telegram_me.jpg" class="ad-server__qr" style="border-radius: 1em;">
    ...
    function formatDays(user) {
      ...
      const remainingDays = Math.ceil(
        (subscribeDate - new Date()) / (1000 * 60 * 60 * 24)
      );
          ...
          $(".extensions__item", Lampa.Extensions.render()).each(function (
            ...
            if (regex.test(descr)) {
              $(e)
                ...
                .html("💎")
                .append(
                  '<span class="extensions__item-premium">VIP buy at @abrosxd</span>'
                );
              $(e).find(".extensions__item-name").html("Abros");
              $(e)
